/*
    Spawn 2 process A and B, where B is child of A. In this case when detachment takes place, the parent is not waiting for the child.
*/
...
int main() {
    ...
    printf("Parent Returned from WAIT, Now Exiting\n");
    return 0;
}
